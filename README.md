...
- Were you involved in other OpenSource development projects in the past? Which, when and in what role?
  ...
  I authored the [iio: proximity: add driver for ST VL53L1X](https://lore.kernel.org/linux-iio/20260313113737.151881-1-email@sirat.me) patch series (v5, under review) for the Linux kernel mainline
...
- W7: Biometric UV: wire fido2_uv_perform to ZFM-x0/GT-5x drivers, PIN fallback path.
...
**Post-GSoC**
BLE transport. NFC transport once the Zephyr NFC subsystem (currently in RFC) is merged.
